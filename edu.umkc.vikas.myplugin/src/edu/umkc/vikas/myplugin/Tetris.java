...
public class Tetris extends JFrame {
	 ...
	 */
	public Tetris(Object o, Object o2) {
		/*
		...
		obj2 = o2;
		((SidePanel) obj2).initializeTetris(this);
		((SidePanel) obj2).setStyle();
		/*
		 * Add the BoardPanel and SidePanel instances to the window.
		 */
		add(board, BorderLayout.CENTER);
		add(((SidePanel) o2), BorderLayout.EAST);
		...
		addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				...
				case KeyEvent.VK_S:
					if(!isPaused && dropCooldown == 0) {
						((Clock) obj).setCyclesPerSecond(25.0f);
					}
					break;
			...
			public void keyReleased(KeyEvent e) {
				 ...
				 */
				case KeyEvent.VK_S:
					((Clock) obj).setCyclesPerSecond(gameSpeed);
					((Clock) obj).reset();
					break;
				}
	...
	public void startGame() {
		...
		((Clock) obj).setCyclesPerSecond(1.0f);
		((Clock) obj).reset();
		((Clock) obj).setPaused(true);
